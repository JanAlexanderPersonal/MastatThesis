...
\par{
    ...
    The final results are illustrated in figure \ref{fig:fullvsPseudo}.
    The hyperparameters of this model were optimized in the same way as the reference model.
    Just like for the reference model, the unweighted cross entropy loss proves to yield better results than the weighted cross entropy loss.
