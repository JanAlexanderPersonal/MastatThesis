...
\par{
    This part first describes the datasets used in this research. Then, the model results obtained with these datasets are discussed.
}
\par{
...
\input{/home/thesis/3_Results/data}
