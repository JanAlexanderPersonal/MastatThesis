...
\par{
    First, as described in chapter \ref{sec:reference_model}, first, a reference is calculated to compare the performance of the weakly supervised models.
    The reference models have the same architecture trained on the same dataset as the weakly supervised models. 
