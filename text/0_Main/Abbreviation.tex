...
description={
        Unit of attenuation of X-ray waves. The radiodensity of air is $HU = -1000$, while the radiodensity of distilled water is $HU=0$.
...
\newglossaryentry{features}{
        ...
        description={
                ...
                In deep learning applications, the feature set (precisely the feature set resulting from a contracting path) is often called the \textit{encoding}.
                },
        text={features}
        }
