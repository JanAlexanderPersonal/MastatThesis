...
\begin{SCfigure}[][htb]
    \includegraphics[width=0.95\textwidth]{images/USiegen_004_50_crops.png}
    \caption{Sagittal slice 50 of the USiegen 04 volume has to be evaluated in 4 crops due to its dimensions. The recombination of these crops to form the mask for the slice is illustrated in this figure.}
\end{SCfigure}
...
\begin{enumerate}
    ...
    \item All models tend to over-estimate the extend of the vertebrae. This causes a low recall score. The direction in which the predictions tend to \textit{bleed out} is different for the different models. 
\end{enumerate}
