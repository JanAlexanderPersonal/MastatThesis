...
\node[canvas is zy plane at x=0] (temp) at (-5,0,0) {\includegraphics[width=8cm,height=8cm]{/home/thesis/PlotNeuralNets/images/input.png}};
\node[canvas is zy plane at x=0] (temp) at (-4,0,0) {\includegraphics[width=8cm,height=8cm]{/home/thesis/PlotNeuralNets/images/input.png}};
\node[canvas is zy plane at x=0] (temp) at (-3,0,0) {\includegraphics[width=8cm,height=8cm]{/home/thesis/PlotNeuralNets/images/input.png}};
...
\pic[shift={ (.5,-5,0) }] at (pool_b1-east) 
    {RightBandedBox={
        name=ccr_b2,
        caption= ,
        xlabel={{ 128,128 }},
...
\pic[shift={ (.5,-5,0) }] at (pool_b2-east) 
    {RightBandedBox={
        name=ccr_b3,
        caption= ,
        xlabel={{ 256,256 }},
...
\pic[shift={ (.5,-5,0) }] at (pool_b3-east) 
    {RightBandedBox={
        name=ccr_b4,
        caption= ,
        xlabel={{ 512,512 }},
...
\pic[shift={ (.5,0,0) }] at (pool_b4-east) 
    {RightBandedBox={
        name=ccr_b5,
        caption=Bottleneck,
        xlabel={{ 1024,1024 }},
...
% to_UnPool
\pic[shift={ (.5,0,0) }] at (ccr_b5-east) 
    {Box={
        name=unpool_b6,
        caption= ,
        fill=\UnpoolColor,
...
% to_UnPool
\pic[shift={ (.5,5,0) }] at (end_b6-east) 
    {Box={
        name=unpool_b7,
        caption= ,
        fill=\UnpoolColor,
...
% to_UnPool
\pic[shift={ (.5,5,0) }] at (end_b7-east) 
    {Box={
        name=unpool_b8,
        caption= ,
        fill=\UnpoolColor,
...
% to_UnPool
\pic[shift={ (.5,5,0) }] at (end_b8-east) 
    {Box={
        name=unpool_b9,
        caption= ,
        fill=\UnpoolColor,
