...
def get_dataset(dataset_dict, split, datadir, exp_dict, dataset_size=None, separate_source=None, precalculated_points = False):
    ...
    if name == "covid19_v2_sep":
        ...
        dataset = spine_dataset.SpineSets(split=split, datadir=datadir, exp_dict=exp_dict, separate_source=separate_source, precalculated_points=precalculated_points)
        if dataset_size is not None and dataset_size.get(split, 'all') != 'all':
            dataset.img_list = dataset.img_list[:dataset_size[split]] 
