...
do
    ...
    do
        ...
        python3.8 trainval.py -e full_spine_dataset_c6_red -sb $PATH_OP/results_full_dataset_${d}_contrast_$c -d $PATH_OP/dataset_${d}_contrast_$c/ -tb $PATH_OP/tensorboard_full_d_${d}_c_${c} -r 0
...
do
    ...
    do
        ...
        python3.8 trainval.py -e weakly_spine_dataset_c6_red -sb $PATH_OP/results_dataset_${d}_contrast_$c -d $PATH_OP/dataset_${d}_contrast_$c/ -tb $PATH_OP/tensorboard_d_${d}_c_${c} -r 0
