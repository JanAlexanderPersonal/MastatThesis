...
python3.8 reconstruct.py -mn results_precalc_dataset_D_contrast_3  -sd $PATH_OP/reconstruct_from_precalc -gt $PATH_OP/dataset_1_contrast_3 -ed Combine_one_stack -pd dataset_2_pseudo
