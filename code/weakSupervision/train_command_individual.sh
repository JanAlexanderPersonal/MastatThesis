...
PATH_DATA=/root/space/code/DataPreparation
...
do
    ...
    python3.8 trainval_Individual.py -e single_class -sb $PATH_OP/results_weighted_dataset_${d}_contrast_${c} -d $PATH_OP/dataset_${d}_contrast_$c/ -tb $PATH_OP/tensorboard_full_d_${d}_c_${c} -r 0
done
